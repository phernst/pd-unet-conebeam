...
from train_fdkconvnet import FDKConvnet
...
def main(run_name: str, save_visuals: bool = False):
    ...
    with torch.inference_mode():
        for batch_idx, batch in enumerate(tqdm(dataloader_test)):
            ...
            batch_sparse_fdk = fdk_reconstruction(batch_sparse_sino, model.radon, 'hann')
            batch_prediction = model(batch_sparse_fdk)
...
if __name__ == '__main__':
    ...
    # main('sparse16_fdkconv')
    create_visuals('sparse16_fdkconv')
